...
var _goalapp = __webpack_require__(82);

var _goalapp2 = _interopRequireDefault(_goalapp);
...
_reactDom2.default.render(_react2.default.createElement(
    ...
    null,
    _react2.default.createElement(_goalapp2.default, null)
...
var GoalApp = function (_React$Component) {
    _inherits(GoalApp, _React$Component);

    function GoalApp(props) {
        _classCallCheck(this, GoalApp);

        var _this = _possibleConstructorReturn(this, (GoalApp.__proto__ || Object.getPrototypeOf(GoalApp)).call(this, props));
        ...
        _this.updateGoalName = _this.updateGoalName.bind(_this);
        _this.updateGoalAmount = _this.updateGoalAmount.bind(_this);
        _this.handleUploadFile = _this.handleUploadFile.bind(_this);
        _this.updateSavingAmount = _this.updateSavingAmount.bind(_this);
        _this.updateSavingTime = _this.updateSavingTime.bind(_this);
        _this._calculateSavingGoals = _this._calculateSavingGoals.bind(_this);
        return _this;
    }

    _createClass(GoalApp, [{
        key: 'updateGoalName',
        value: function updateGoalName(value) {
            this.setState({ goalName: value });
        }
    }, {
        key: 'updateGoalAmount',
        value: function updateGoalAmount(value) {
            //TODO: checks for NaN
            this.setState({ goalAmount: value });
            this._calculateSavingGoals();
        }
    }, {
        key: 'updateSavingAmount',
        value: function updateSavingAmount(value) {
            this.setState({ savingAmount: value });
            this._calculateSavingGoals();
        }
    }, {
        key: 'updateSavingTime',
        value: function updateSavingTime(value) {
        ...
        value: function triggerUpload() {
            var fileUploader = this.refs.goalPhoto;
            fileUploader.click();
        }
    }, {
        ...
        value: function handleUploadFile(event) {
            ...
            _axios2.default.post('/upload', data).then(function (response) {
                if (response.data.status == "success") {
                    var fileName = '<img src=\'/files/' + response.data.filename + '\'>';
                    _this2.setState({ goalImage: fileName });
                } else console.log(response.err);
            });
        }
    }, {
        key: 'updateGoalImage',
        value: function updateGoalImage(imgsrc) {
            this.setState({ goalImage: imgsrc });
        }
    }, {
        key: '_calculateSavingGoals',
        value: function _calculateSavingGoals() {
            if (this.state.goalAmount == 0 || this.state.savingAmount == 0) return;
            var savingGoals = {};
            var savingTime = this.state.goalAmount / this.state.savingAmount;
            var savingInterval = savingTime / 4;
            var i = 1;
            while (i < 5) {
                savingGoals[i] = {
        ...
        value: function render() {
            var goalName = this.state.goalName;
            var goalAmount = this.state.goalAmount;
            var goalImage = this.state.goalImage;
            var savingAmount = this.state.savingAmount;
            var savingTime = this.state.savingTime;
            var savingGoals = this.state.savingGoals;
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'h2',
                    null,
                    'MAKE YOUR OWN SMART GOAL LABEL'
                ),
                _react2.default.createElement(
                    'div',
                    { id: 'title' },
                ...
                _react2.default.createElement(Goalname, { updateGoalName: this.updateGoalName, handleFileUpload: this.handleUploadFile, triggerUpload: this.triggerUpload }),
                _react2.default.createElement(Goaltotal, { updateGoalAmount: this.updateGoalAmount }),
                _react2.default.createElement(Achievable, null),
                _react2.default.createElement(Relevant, null),
                _react2.default.createElement(Timebased, { updateSavingAmount: this.updateSavingAmount, updateSavingTime: this.updateSavingTime }),
                _react2.default.createElement(Jarlabel, { goalName: goalName, goalAmount: goalAmount, goalImage: goalImage, savingAmount: savingAmount, savingTime: savingTime }),
                _react2.default.createElement(Savingsthermometer, { savingGoals: savingGoals, savingTime: savingTime })
            );
        }
    }]);
...
exports.default = GoalApp;

var Goalname = function (_React$Component2) {
    _inherits(Goalname, _React$Component2);

    function Goalname(props) {
        _classCallCheck(this, Goalname);

        var _this3 = _possibleConstructorReturn(this, (Goalname.__proto__ || Object.getPrototypeOf(Goalname)).call(this, props));

        _this3.handleChange = _this3.handleChange.bind(_this3);
        return _this3;
    }

    _createClass(Goalname, [{
        key: 'handleChange',
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'span',
                    { className: 'sectionAnswer' },
                    _react2.default.createElement('input', { type: 'text', id: 'goalName', onChange: this.handleChange }),
                    _react2.default.createElement('br', null),
                    _react2.default.createElement(Pictureupload, { updateGoalImage: this.props.handleFileUpload, triggerUpload: this.props.triggerUpload })
                )
            );
        }
    }]);
...
var Pictureupload = function (_React$Component3) {
    _inherits(Pictureupload, _React$Component3);

    function Pictureupload(props) {
        _classCallCheck(this, Pictureupload);

        var _this4 = _possibleConstructorReturn(this, (Pictureupload.__proto__ || Object.getPrototypeOf(Pictureupload)).call(this, props));

        _this4.handleChange = _this4.handleChange.bind(_this4);
        _this4.clickUpload = _this4.clickUpload.bind(_this4);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement('input', { type: 'file', ref: function ref(input) {
                        _this5.fileInput = input;
                    }, id: 'goalPhoto', name: 'goalPhoto', onChange: this.handleChange }),
                _react2.default.createElement(
                    'span',
                    { id: 'uploadPictureButton', onClick: this.clickUpload },
                    'Upload Picture'
                )
            );
        }
...
var Goaltotal = function (_React$Component4) {
    _inherits(Goaltotal, _React$Component4);

    function Goaltotal(props) {
        _classCallCheck(this, Goaltotal);

        var _this6 = _possibleConstructorReturn(this, (Goaltotal.__proto__ || Object.getPrototypeOf(Goaltotal)).call(this, props));

        _this6.handleChange = _this6.handleChange.bind(_this6);
        return _this6;
    }

    _createClass(Goaltotal, [{
        key: 'handleChange',
        value: function handleChange(e) {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        '(and don\'t forget tax and shipping)'
                    )
                ),
                _react2.default.createElement('input', { type: 'number', id: 'goalAmount', onChange: this.handleChange })
            );
        }
    }]);
...
var Achievable = function (_React$Component5) {
    _inherits(Achievable, _React$Component5);

    function Achievable() {
        _classCallCheck(this, Achievable);

        return _possibleConstructorReturn(this, (Achievable.__proto__ || Object.getPrototypeOf(Achievable)).apply(this, arguments));
    }

    _createClass(Achievable, [{
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                'div',
                ...
                _react2.default.createElement(
                    'span',
                    { className: 'sectionText' },
                    'Can you save enough for this goal?'
                ),
                _react2.default.createElement('input', { type: 'checkbox', className: 'checkboxAchievable' }),
                _react2.default.createElement(
                    'span',
                    { className: 'sectionAnswer' },
                    'Yes, I can!'
...
var Relevant = function (_React$Component6) {
    _inherits(Relevant, _React$Component6);

    function Relevant() {
        _classCallCheck(this, Relevant);

        return _possibleConstructorReturn(this, (Relevant.__proto__ || Object.getPrototypeOf(Relevant)).apply(this, arguments));
    }
    ...
    _createClass(Relevant, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement('input', { type: 'checkbox', className: 'checkboxRelevant' }),
                _react2.default.createElement(
                    'span',
                    { className: 'sectionAnswer' },
                    'Yes, I do!'
...
var Timebased = function (_React$Component7) {
    _inherits(Timebased, _React$Component7);

    function Timebased(props) {
        _classCallCheck(this, Timebased);

        var _this9 = _possibleConstructorReturn(this, (Timebased.__proto__ || Object.getPrototypeOf(Timebased)).call(this, props));

        _this9.handleChange = _this9.handleChange.bind(_this9);
        _this9.handleTimeChange = _this9.handleTimeChange.bind(_this9);
        return _this9;
    }

    _createClass(Timebased, [{
        key: 'handleChange',
        value: function handleChange(e) {
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    'I can save',
                    _react2.default.createElement('br', null),
                    _react2.default.createElement('input', { type: 'number', id: 'savingAmount', onChange: this.handleChange }),
                    _react2.default.createElement('br', null),
                    _react2.default.createElement('input', { id: 'week', type: 'radio', name: 'savingTime', value: 'week', onChange: this.handleTimeChange }),
                    ' ',
                    _react2.default.createElement(
                        'span',
                        { className: 'sectionAnswer' },
                    ...
                    _react2.default.createElement('br', null),
                    _react2.default.createElement('input', { id: 'month', type: 'radio', name: 'savingTime', value: 'month', onChange: this.handleTimeChange }),
                    _react2.default.createElement(
                        'span',
                        { className: 'sectionAnswer' },
                        'Monthly'
...
var Jarlabel = function (_React$Component8) {
    _inherits(Jarlabel, _React$Component8);

    function Jarlabel(props) {
        _classCallCheck(this, Jarlabel);

        return _possibleConstructorReturn(this, (Jarlabel.__proto__ || Object.getPrototypeOf(Jarlabel)).call(this, props));
    }

    _createClass(Jarlabel, [{
        key: 'getGoalImage',
        value: function getGoalImage() {
            return { '__html': this.props.goalImage };
        }
    }, {
        key: 'getGoalAmount',
        value: function getGoalAmount() {
            if (this.props.goalAmount == 0) return '';else return '$' + parseFloat(Math.round(parseFloat(this.props.goalAmount) * 100) / 100).toFixed(2);
        }
    }, {
        key: 'getSavingAmount',
        value: function getSavingAmount() {
            if (this.props.savingAmount == 0) return '';else return ' ($' + parseFloat(Math.round(parseFloat(this.props.savingAmount) * 100) / 100).toFixed(2) + ' per ' + this.props.savingTime + ')';
        }
    }, {
        key: 'render',
        value: function render() {
            if (this.props.goalName == '' && this.props.goalImage == '') {
                ...
                return _react2.default.createElement(
                    'div',
                    { className: 'aoa_calculator', id: 'jarLabel' },
                    _react2.default.createElement(
                        'div',
                    ...
                    _react2.default.createElement(
                        'div',
                        { id: 'jarContainer' },
                        _react2.default.createElement('div', { id: 'jarGoalImage', dangerouslySetInnerHTML: this.getGoalImage() }),
                        _react2.default.createElement(
                            'div',
                            { id: 'jarGoalName' },
                            this.props.goalName
...
var Savingsthermometer = function (_React$Component9) {
    _inherits(Savingsthermometer, _React$Component9);

    function Savingsthermometer(props) {
        _classCallCheck(this, Savingsthermometer);

        return _possibleConstructorReturn(this, (Savingsthermometer.__proto__ || Object.getPrototypeOf(Savingsthermometer)).call(this, props));
    }

    _createClass(Savingsthermometer, [{
        key: 'render',
        value: function render() {
            if (this.props.savingGoals[1] != null) {
                return _react2.default.createElement(
                    'div',
                    { className: 'aoa_calculator', id: 'thermoLabel' },
                    _react2.default.createElement(
                        'div',
                        { className: 'printTitle' },
                        'Savings Thermometer'
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'savingGoal' },
                            _react2.default.createElement(
                                'span',
                                { className: 'savingInterval' },
                                this.props.savingGoals[4].savingInterval
                            ),
                            _react2.default.createElement(
                                'span',
                                { className: 'savingAmount' },
                                '$',
                                this.props.savingGoals[4].savingAmount
                            )
                        ),
                        _react2.default.createElement(
                            'div',
                            ...
                            _react2.default.createElement(
                                'span',
                                { className: 'savingInterval' },
                                this.props.savingGoals[3].savingInterval
                            ),
                            _react2.default.createElement(
                                'span',
                                { className: 'savingAmount' },
                                '$',
                                this.props.savingGoals[3].savingAmount
                            )
                        ),
                        _react2.default.createElement(
                            'div',
                            ...
                            _react2.default.createElement(
                                'span',
                                { className: 'savingInterval' },
                                this.props.savingGoals[2].savingInterval
                            ),
                            _react2.default.createElement(
                                'span',
                                { className: 'savingAmount' },
                                '$',
                                this.props.savingGoals[2].savingAmount
                            )
                        ),
                        _react2.default.createElement(
                            'div',
                            ...
                            _react2.default.createElement(
                                'span',
                                { className: 'savingInterval' },
                                this.props.savingGoals[1].savingInterval
                            ),
                            _react2.default.createElement(
                                'span',
                                { className: 'savingAmount' },
                                '$',
                                this.props.savingGoals[1].savingAmount
                            )
                        )
                    )
                );
